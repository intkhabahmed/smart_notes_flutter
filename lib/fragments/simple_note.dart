...
class SimpleNote extends StatefulWidget {
  @override
  _SimpleNoteState createState() => _SimpleNoteState();
}

class _SimpleNoteState extends State<SimpleNote> {
  @override
  Widget build(BuildContext context) {
    return Consumer<DBNotifier>(
      builder: (context, dbNotifier, child) {
        dbNotifier.setNotesByType(type: Constants.SIMPLE_NOTE, trash: 0);
        var notes = dbNotifier.getNotesByType(Constants.SIMPLE_NOTE);
